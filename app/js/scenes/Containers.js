...
var CONTAINERS = require('../../data/contenedores.json');
...
class Containers extends Component {
  ...
  //   this.setState({
  //     containers: this.state.containers.cloneWithRows(containers)
  //   });
  // }
  ...
  render() {
    ...
    let containersMarkers = this.state.containers.map(function(container, i){
                        let coordinate = {latitude: container.latitude, longitude: container.longitude};
